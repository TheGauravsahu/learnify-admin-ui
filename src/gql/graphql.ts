...
export type LoginMutation = { __typename?: 'Mutation', login?: { __typename?: 'AuthPayload', token: string, user: { __typename?: 'User', _id: string, name: string, email: string, role: Role, updatedAt: string } } | null };
