...
export type DashboardOverview = {
  ...
  classWiseStudents: Array<ClassStudentCount>;
...
export type GetDashboardStatsQuery = { __typename?: 'Query', adminDashboard: { __typename?: 'DashboardOverview', counts: { __typename?: 'DashboardCounts', students: number, classes: number, notices: number, teachers: number, parents: number }, genderStats: { __typename?: 'GenderStats', boys: number, girls: number }, latestNotices: Array<{ __typename?: 'Notice', title: string, description: string, createdAt: string, _id: string }> } };
